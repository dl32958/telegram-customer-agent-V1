...
def create_root_agent(config: Config, product_query_agent: SequentialAgent, order_form_agent: Agent, convincing_response_agent: Agent, order_status_agent: Agent) -> Agent:
    return Agent(
        ...
        description="Handles user interactions as a friendly, talkative salesman for PerfumePal E-commerce, supporting product queries, order placement, order cancellation, and order status checks.",
        instruction=(
            "You are a very friendly and talkative sales agent for PerfumePal E-commerce. "
            ...
            "4. If the query is empty or ambiguous, respond: 'Welcome to PerfumePal E-commerce! We’re a premium perfume brand. You can ask about our fragrances, place an order or check your order status. How can I assist you today?'\n\n"
